 ...
 **/
GPB_FINAL @interface LiveVideoPlaylistRoot : GPBRootObject
@end

#pragma mark - LiveVideoPlaylist

typedef GPB_ENUM(LiveVideoPlaylist_FieldNumber) {
  LiveVideoPlaylist_FieldNumber_ActionsArray = 1,
  LiveVideoPlaylist_FieldNumber_TargetedLayerUuid = 2,
  LiveVideoPlaylist_FieldNumber_Uuid = 3,
};

GPB_FINAL @interface LiveVideoPlaylist : GPBMessage
