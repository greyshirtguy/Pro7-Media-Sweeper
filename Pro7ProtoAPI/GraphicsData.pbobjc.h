...
typedef GPB_ENUM(Graphics_Text_ChordPro_Notation) {
  /**
   * Value used if any message's field encounters a value that is not defined
   * by this enum. The message will also have C functions to get/set the rawValue
   * of the field.
   **/
  Graphics_Text_ChordPro_Notation_GPBUnrecognizedEnumeratorValue = kGPBUnrecognizedEnumeratorValue,
  Graphics_Text_ChordPro_Notation_NotationChords = 0,
  Graphics_Text_ChordPro_Notation_NotationNumbers = 1,
  Graphics_Text_ChordPro_Notation_NotationNumerals = 2,
  Graphics_Text_ChordPro_Notation_NotationDoReMi = 3,
};
 ...
 * the time this source was generated.
 **/
BOOL Graphics_Text_ChordPro_Notation_IsValidValue(int32_t value);
...
typedef GPB_ENUM(Graphics_Text_FieldNumber) {
  ...
  Graphics_Text_FieldNumber_ChordPro = 12,
};
...
@property(nonatomic, readwrite, strong, null_resettable) Graphics_Text_ChordPro *chordPro;
/** Test to see if @c chordPro has been set. */
@property(nonatomic, readwrite) BOOL hasChordPro;
...
typedef GPB_ENUM(Graphics_Text_ChordPro_FieldNumber) {
  Graphics_Text_ChordPro_FieldNumber_Enabled = 1,
  Graphics_Text_ChordPro_FieldNumber_Notation = 2,
  Graphics_Text_ChordPro_FieldNumber_Color = 3,
};

GPB_FINAL @interface Graphics_Text_ChordPro : GPBMessage

@property(nonatomic, readwrite) BOOL enabled;

@property(nonatomic, readwrite) Graphics_Text_ChordPro_Notation notation;
...
/**
 * Fetches the raw value of a @c Graphics_Text_ChordPro's @c notation property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t Graphics_Text_ChordPro_Notation_RawValue(Graphics_Text_ChordPro *message);
/**
 * Sets the raw value of an @c Graphics_Text_ChordPro's @c notation property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
...
typedef GPB_ENUM(Graphics_Text_Attributes_CustomAttribute_FieldNumber) {
  ...
  Graphics_Text_Attributes_CustomAttribute_FieldNumber_Chord = 7,
};
...
typedef GPB_ENUM(Graphics_Text_Attributes_CustomAttribute_Attribute_OneOfCase) {
  ...
  Graphics_Text_Attributes_CustomAttribute_Attribute_OneOfCase_Chord = 7,
};
...
@property(nonatomic, readwrite, copy, null_resettable) NSString *chord;
