...
GPBObjCClassDeclaration(MusicKeyScale);
...
GPBObjCClassDeclaration(Presentation_MultiTracksLicensing);
GPBObjCClassDeclaration(Presentation_Music);
...
@dynamic hasMultiTracksLicensing, multiTracksLicensing;
@dynamic musicKey;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "multiTracksLicensing",
        .dataTypeSpecific.clazz = GPBObjCClass(Presentation_MultiTracksLicensing),
        .number = Presentation_FieldNumber_MultiTracksLicensing,
        .hasIndex = 16,
        .offset = (uint32_t)offsetof(Presentation__storage_, multiTracksLicensing),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "musicKey",
        .dataTypeSpecific.clazz = Nil,
        .number = Presentation_FieldNumber_MusicKey,
        .hasIndex = 17,
        .offset = (uint32_t)offsetof(Presentation__storage_, musicKey),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "music",
        .dataTypeSpecific.clazz = GPBObjCClass(Presentation_Music),
        .number = Presentation_FieldNumber_Music,
        .hasIndex = 18,
        .offset = (uint32_t)offsetof(Presentation__storage_, music),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
    };
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "album",
        .dataTypeSpecific.clazz = Nil,
        .number = Presentation_CCLI_FieldNumber_Album,
        .hasIndex = 8,
        .offset = (uint32_t)offsetof(Presentation_CCLI__storage_, album),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "artwork",
        .dataTypeSpecific.clazz = Nil,
        .number = Presentation_CCLI_FieldNumber_Artwork,
        .hasIndex = 9,
        .offset = (uint32_t)offsetof(Presentation_CCLI__storage_, artwork),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
...
@implementation Presentation_MultiTracksLicensing

@dynamic songIdentifier;
@dynamic customerIdentifier;
@dynamic hasExpirationDate, expirationDate;
@dynamic hasLicenseExpiration, licenseExpiration;
@dynamic subscription;

typedef struct Presentation_MultiTracksLicensing__storage_ {
  uint32_t _has_storage_[1];
  Presentation_MultiTracksLicensing_Subscription subscription;
  NSString *customerIdentifier;
  Timestamp *expirationDate;
  Timestamp *licenseExpiration;
  int64_t songIdentifier;
} Presentation_MultiTracksLicensing__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "songIdentifier",
        .dataTypeSpecific.clazz = Nil,
        .number = Presentation_MultiTracksLicensing_FieldNumber_SongIdentifier,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(Presentation_MultiTracksLicensing__storage_, songIdentifier),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = Nil,
        .number = Presentation_MultiTracksLicensing_FieldNumber_CustomerIdentifier,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(Presentation_MultiTracksLicensing__storage_, customerIdentifier),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "expirationDate",
        .dataTypeSpecific.clazz = GPBObjCClass(Timestamp),
        .number = Presentation_MultiTracksLicensing_FieldNumber_ExpirationDate,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(Presentation_MultiTracksLicensing__storage_, expirationDate),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(Timestamp),
        .number = Presentation_MultiTracksLicensing_FieldNumber_LicenseExpiration,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(Presentation_MultiTracksLicensing__storage_, licenseExpiration),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "subscription",
        .dataTypeSpecific.enumDescFunc = Presentation_MultiTracksLicensing_Subscription_EnumDescriptor,
        .number = Presentation_MultiTracksLicensing_FieldNumber_Subscription,
        .hasIndex = 4,
        .offset = (uint32_t)offsetof(Presentation_MultiTracksLicensing__storage_, subscription),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldHasEnumDescriptor | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeEnum,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[Presentation_MultiTracksLicensing class]
                                     rootClass:[PresentationRoot class]
                                          file:PresentationRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(Presentation_MultiTracksLicensing__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    [localDescriptor setupContainingMessageClass:GPBObjCClass(Presentation)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
...
int32_t Presentation_MultiTracksLicensing_Subscription_RawValue(Presentation_MultiTracksLicensing *message) {
  GPBDescriptor *descriptor = [Presentation_MultiTracksLicensing descriptor];
  GPBFieldDescriptor *field = [descriptor fieldWithNumber:Presentation_MultiTracksLicensing_FieldNumber_Subscription];
  return GPBGetMessageRawEnumField(message, field);
}
...
GPBEnumDescriptor *Presentation_MultiTracksLicensing_Subscription_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        "SubscriptionChartPro\000SubscriptionSlidePr"
        "o\000";
    static const int32_t values[] = {
        Presentation_MultiTracksLicensing_Subscription_SubscriptionChartPro,
        Presentation_MultiTracksLicensing_Subscription_SubscriptionSlidePro,
    };
    GPBEnumDescriptor *worker =
        [GPBEnumDescriptor allocDescriptorForName:GPBNSStringifySymbol(Presentation_MultiTracksLicensing_Subscription)
                                       valueNames:valueNames
                                           values:values
                                            count:(uint32_t)(sizeof(values) / sizeof(int32_t))
                                     enumVerifier:Presentation_MultiTracksLicensing_Subscription_IsValidValue];
    GPBEnumDescriptor *expected = nil;
    if (!atomic_compare_exchange_strong(&descriptor, &expected, worker)) {
      [worker release];
    }
...
BOOL Presentation_MultiTracksLicensing_Subscription_IsValidValue(int32_t value__) {
  switch (value__) {
    case Presentation_MultiTracksLicensing_Subscription_SubscriptionChartPro:
    case Presentation_MultiTracksLicensing_Subscription_SubscriptionSlidePro:
      return YES;
    default:
      return NO;
  }
...
@implementation Presentation_Music

@dynamic originalMusicKey;
@dynamic userMusicKey;
@dynamic hasOriginal, original;
@dynamic hasUser, user;

typedef struct Presentation_Music__storage_ {
  uint32_t _has_storage_[1];
  NSString *originalMusicKey;
  NSString *userMusicKey;
  MusicKeyScale *original;
  MusicKeyScale *user;
} Presentation_Music__storage_;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "originalMusicKey",
        .dataTypeSpecific.clazz = Nil,
        .number = Presentation_Music_FieldNumber_OriginalMusicKey,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(Presentation_Music__storage_, originalMusicKey),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "userMusicKey",
        .dataTypeSpecific.clazz = Nil,
        .number = Presentation_Music_FieldNumber_UserMusicKey,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(Presentation_Music__storage_, userMusicKey),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "original",
        .dataTypeSpecific.clazz = GPBObjCClass(MusicKeyScale),
        .number = Presentation_Music_FieldNumber_Original,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(Presentation_Music__storage_, original),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "user",
        .dataTypeSpecific.clazz = GPBObjCClass(MusicKeyScale),
        .number = Presentation_Music_FieldNumber_User,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(Presentation_Music__storage_, user),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[Presentation_Music class]
                                     rootClass:[PresentationRoot class]
                                          file:PresentationRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(Presentation_Music__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    [localDescriptor setupContainingMessageClass:GPBObjCClass(Presentation)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
