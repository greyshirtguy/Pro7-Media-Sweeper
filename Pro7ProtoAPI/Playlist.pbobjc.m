...
@dynamic hasUserMusicKey, userMusicKey;
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .number = PlaylistItem_Presentation_FieldNumber_UserMusicKey,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(PlaylistItem_Presentation__storage_, userMusicKey),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
    };
