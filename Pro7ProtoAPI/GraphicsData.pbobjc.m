...
GPBObjCClassDeclaration(Graphics_Text_ChordPro);
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "chordPro",
        .dataTypeSpecific.clazz = GPBObjCClass(Graphics_Text_ChordPro),
        .number = Graphics_Text_FieldNumber_ChordPro,
        .hasIndex = 10,
        .offset = (uint32_t)offsetof(Graphics_Text__storage_, chordPro),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
    };
...
#pragma mark - Graphics_Text_ChordPro

@implementation Graphics_Text_ChordPro

@dynamic enabled;
@dynamic notation;
@dynamic hasColor, color;

typedef struct Graphics_Text_ChordPro__storage_ {
  uint32_t _has_storage_[1];
  Graphics_Text_ChordPro_Notation notation;
  Color *color;
} Graphics_Text_ChordPro__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "enabled",
        .dataTypeSpecific.clazz = Nil,
        .number = Graphics_Text_ChordPro_FieldNumber_Enabled,
        .hasIndex = 0,
        .offset = 1,  // Stored in _has_storage_ to save space.
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeBool,
      ...
      {
        .name = "notation",
        .dataTypeSpecific.enumDescFunc = Graphics_Text_ChordPro_Notation_EnumDescriptor,
        .number = Graphics_Text_ChordPro_FieldNumber_Notation,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(Graphics_Text_ChordPro__storage_, notation),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldHasEnumDescriptor | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeEnum,
      },
      {
        .name = "color",
        .dataTypeSpecific.clazz = GPBObjCClass(Color),
        .number = Graphics_Text_ChordPro_FieldNumber_Color,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(Graphics_Text_ChordPro__storage_, color),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[Graphics_Text_ChordPro class]
                                     rootClass:[GraphicsDataRoot class]
                                          file:GraphicsDataRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(Graphics_Text_ChordPro__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    [localDescriptor setupContainingMessageClass:GPBObjCClass(Graphics_Text)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
...
int32_t Graphics_Text_ChordPro_Notation_RawValue(Graphics_Text_ChordPro *message) {
  GPBDescriptor *descriptor = [Graphics_Text_ChordPro descriptor];
  GPBFieldDescriptor *field = [descriptor fieldWithNumber:Graphics_Text_ChordPro_FieldNumber_Notation];
  return GPBGetMessageRawEnumField(message, field);
}

void SetGraphics_Text_ChordPro_Notation_RawValue(Graphics_Text_ChordPro *message, int32_t value) {
  GPBDescriptor *descriptor = [Graphics_Text_ChordPro descriptor];
  GPBFieldDescriptor *field = [descriptor fieldWithNumber:Graphics_Text_ChordPro_FieldNumber_Notation];
  GPBSetMessageRawEnumField(message, field, value);
}

#pragma mark - Enum Graphics_Text_ChordPro_Notation

GPBEnumDescriptor *Graphics_Text_ChordPro_Notation_EnumDescriptor(void) {
  static _Atomic(GPBEnumDescriptor*) descriptor = nil;
  if (!descriptor) {
    static const char *valueNames =
        "NotationChords\000NotationNumbers\000NotationN"
        "umerals\000NotationDoReMi\000";
    static const int32_t values[] = {
        Graphics_Text_ChordPro_Notation_NotationChords,
        Graphics_Text_ChordPro_Notation_NotationNumbers,
        Graphics_Text_ChordPro_Notation_NotationNumerals,
        Graphics_Text_ChordPro_Notation_NotationDoReMi,
    };
    GPBEnumDescriptor *worker =
        [GPBEnumDescriptor allocDescriptorForName:GPBNSStringifySymbol(Graphics_Text_ChordPro_Notation)
                                       valueNames:valueNames
                                           values:values
                                            count:(uint32_t)(sizeof(values) / sizeof(int32_t))
                                     enumVerifier:Graphics_Text_ChordPro_Notation_IsValidValue];
    GPBEnumDescriptor *expected = nil;
    if (!atomic_compare_exchange_strong(&descriptor, &expected, worker)) {
      [worker release];
    }
...
BOOL Graphics_Text_ChordPro_Notation_IsValidValue(int32_t value__) {
  switch (value__) {
    case Graphics_Text_ChordPro_Notation_NotationChords:
    case Graphics_Text_ChordPro_Notation_NotationNumbers:
    case Graphics_Text_ChordPro_Notation_NotationNumerals:
    case Graphics_Text_ChordPro_Notation_NotationDoReMi:
      return YES;
    default:
      return NO;
  }
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "chord",
        .dataTypeSpecific.clazz = Nil,
        .number = Graphics_Text_Attributes_CustomAttribute_FieldNumber_Chord,
        .hasIndex = -1,
        .offset = (uint32_t)offsetof(Graphics_Text_Attributes_CustomAttribute__storage_, chord),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
    };
