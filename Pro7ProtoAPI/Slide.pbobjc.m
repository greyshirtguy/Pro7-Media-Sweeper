...
GPBObjCClassDeclaration(Slide_Element_DataLink_ChordProChart);
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "chordProChart",
        .dataTypeSpecific.clazz = GPBObjCClass(Slide_Element_DataLink_ChordProChart),
        .number = Slide_Element_DataLink_FieldNumber_ChordProChart,
        .hasIndex = -1,
        .offset = (uint32_t)offsetof(Slide_Element_DataLink__storage_, chordProChart),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
    };
...
@implementation Slide_Element_DataLink_ChordProChart


typedef struct Slide_Element_DataLink_ChordProChart__storage_ {
  uint32_t _has_storage_[1];
} Slide_Element_DataLink_ChordProChart__storage_;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[Slide_Element_DataLink_ChordProChart class]
                                     rootClass:[SlideRoot class]
                                          file:SlideRoot_FileDescriptor()
                                        fields:NULL
                                    fieldCount:0
                                   storageSize:sizeof(Slide_Element_DataLink_ChordProChart__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    [localDescriptor setupContainingMessageClass:GPBObjCClass(Slide_Element_DataLink)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
